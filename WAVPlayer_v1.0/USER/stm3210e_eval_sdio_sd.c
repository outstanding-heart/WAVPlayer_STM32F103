...
/**
  * @brief  Print some info about CarType.
  * @param  None
  * @retval None
  */
void PrintCardType(void)
{
	...
	sprintf(string, " CardType is : %d \n", SDCardInfo.CardType);
	SerialPutString(string);
	sprintf(string, " CardCapacity is : %lld \n", SDCardInfo.CardCapacity);
	SerialPutString(string);
	sprintf(string, " CardCardBlockSize is : %d \n", SDCardInfo.CardBlockSize);
	SerialPutString(string);
	sprintf(string, " CardRCA is : %d \n", SDCardInfo.RCA);
	SerialPutString(string);
	sprintf(string, " ManufacturerID is : %d \n", SDCardInfo.SD_cid.ManufacturerID);
	SerialPutString(string);
}
